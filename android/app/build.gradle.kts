...
android {
    ...
    // Configure signing configs when key.properties is provided
    signingConfigs {
        create("release") {
            // Use properties if available; otherwise leave unset (fallback to debug signing)
            if (keystorePropertiesFile.exists()) {
    ...
    buildTypes {
        release {
            ...
            // Enable code shrinking and resource shrinking for release only
